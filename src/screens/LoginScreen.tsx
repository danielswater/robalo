        ...
        <View style={styles.inner}>
          ...
          <View style={styles.usersBox}>
            {activeUsers.map((u) => {
              ...
              return (
                ...
                >
                  <Text style={[styles.userBtnText, selected && styles.userBtnTextSelected]}>{u.name}</Text>
                  {selected ? (
          ...
          <View style={styles.pinArea}>
            ...
            <Text style={styles.pinHelper}>
              {pinEnabled ? "PIN simples so pra ninguem de fora mexer." : "Escolha um atendente para digitar o PIN."}
            </Text>
